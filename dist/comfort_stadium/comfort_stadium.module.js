...
let ComfortStadiumModule = class ComfortStadiumModule {
};
exports.ComfortStadiumModule = ComfortStadiumModule;
exports.ComfortStadiumModule = ComfortStadiumModule = __decorate([
    (0, common_1.Module)({
        imports: [
            sequelize_1.SequelizeModule.forFeature([comfort_stadium_model_1.ComfortStadium]),
        ],
        controllers: [comfort_stadium_controller_1.ComfortStadiumController],
        providers: [comfort_stadium_service_1.ComfortStadiumService],
    })
